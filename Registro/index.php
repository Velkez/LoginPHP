...
<div>
 <center>
 <form method="POST" action="validar.php"> <!-- validar.php es el
archivo que se encarga de validar los datos ingresados en el formulario -->
<input type="text" name="nnombre" placeholder="Usuario" /> <!-- nnombre es
el nombre del campo que se va a enviar a validar.php -->
 <br />
 <input type="password" name="npassword" placeholder="Contraseña"
/> <!-- npassword es el nombre del campo que se va a enviar a validar.php -->
 <br />
 <button type="submit">Inicar Sesion</button> <!-- Boton de envio
-->
