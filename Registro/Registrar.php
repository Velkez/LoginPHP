<?php include_once('./logic/conexion.php'); //conexion a la base de datos $usuario = $_POST['nnombre']; // Guarda el nombre del usuario ingresado en el formulario 
$pass = $_POST['npassword']; // Guarda el password del usuario ingresado en el formulario 
  ...
  $result1 = mysqli_query($conexion, $sql1); //ejecutamos el query
